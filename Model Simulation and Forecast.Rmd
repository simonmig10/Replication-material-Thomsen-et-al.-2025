...
Sens_1 = TIMESERIES(Sens_1_shock+1 ,START=c(2000,1),  FREQ=1)
)
...
```{r, fig.height=7, fig.width=15}
# Save as PNG
png("Figure_C1_combined.png", width = 6000, height = 4000, res = 300)
...
polygon(c(time_vals, rev(time_vals)),
        c(window(Delta_GHG_tot_cusum_world_S1_sens1 / 1e6, start = c(2026,1)),
          rev(window(Delta_GHG_tot_cusum_world_S1_sens_upper / 1e6, start = c(2026,1)))), 
        col = rgb(1, 0, 0, 0.2), border = NA)

polygon(c(time_vals, rev(time_vals)),
        c(window(Delta_GHG_tot_cusum_world_S2_sens1 / 1e6, start = c(2026,1)),
          rev(window(Delta_GHG_tot_cusum_world_S2_sens_upper / 1e6, start = c(2026,1)))), 
        col = rgb(0, 0, 1, 0.2), border = NA)

polygon(c(time_vals, rev(time_vals)),
        c(window(Delta_GHG_tot_cusum_world_S3_sens1 / 1e6, start = c(2026,1)),
          rev(window(Delta_GHG_tot_cusum_world_S3_sens_upper / 1e6, start = c(2026,1)))), 
        col = rgb(1, 0.5, 0, 0.2), border = NA)

polygon(c(time_vals, rev(time_vals)),
        c(window(Delta_GHG_tot_cusum_world_S4_sens1 / 1e6, start = c(2026,1)),
...
# Global title
mtext("Figure C1: Shadow Price and Cumulative CO2E Reductions across Scenarios (with Sensitivity Ranges)",
